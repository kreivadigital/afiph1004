...
(function ($) {
            ...
            jQuery(".sw-btn-next").hide();
            jQuery('.sw-btn-next').css("position", 'relative');
            jQuery('.sw-btn-next').css("margin-top", '-90px');
            jQuery(".tab-content").height("100%");
